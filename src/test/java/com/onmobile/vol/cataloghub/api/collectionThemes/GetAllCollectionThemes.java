...
public class GetAllCollectionThemes extends RestBaseClass implements Constants {
	/**
	 * 
	...
	public Object[][] getPositiveTestData() {
		...
		Object[][] testData = ExcelConfig.getTestDataAsMap(GET_THEME_XL_PATH, GET_ALL_THEMES_COLLECTION_POSITIVE_SHEET);
		LOGGER.entering(sourceClass, sourceMethod);
		return testData;
	}

	@Test(dataProvider = "getPositiveTestdata")
	public void validateThemesRequest(Map<String, String> testDatList[]) {
